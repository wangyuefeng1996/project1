...
CREATE TABLE user(
  ...
  tele VARCHAR(11) NOT NULL UNIQUE,
  upwd VARCHAR(20) NOT NULL
);
#插入数据
INSERT INTO user VALUES(NULL,"口可口可","18801586700","123456");
...
CREATE TABLE book(
  ...
  bpress VARCHAR(100) NOT NULL,
  bproducer VARCHAR(100),
  boriginal VARCHAR(100),
  btranslator VARCHAR(100),
  bpublic VARCHAR(20) NOT NULL,
  bpagenum SMALLINT,
...
INSERT INTO book VALUES(
  ...
  "东野圭吾，日本著名作家。1958年生于大阪。1985年，以第31届江户川乱步奖获奖作品《放学后》出道，开始扬名立万。20年作品逾60部，几乎囊括日本所有大奖：1999年，《秘密》获第52届日本推理作家协会奖，入围第120届直木奖；2000年，《白夜行》入围第122届直木奖；2001年，《暗恋》入围第125届直木奖；2004年，《幻夜》入围第131届直木奖；2006年的《嫌疑人X的献身》，获得第134届直木奖、第6届本格推理小说大奖。《白夜行》出版之后引起巨大轰动，使东野圭吾成为天王级作家。小说被改编成同名电视连续剧，与图书一同为作家带来了如潮好评，使他成为日本、韩国与台湾等地最受欢迎的作家之一。",
  9.0,
  376360,
  65,
  29,
...
前期作品多写得精巧细致，随着写作功底浸润日深，尤其是《白夜行》之后，笔锋日渐老辣：文字鲜加雕琢，叙述简练凶狠，情节跌宕诡异，故事架构几至匪夷所思的地步。至巅峰之作《嫌疑人X的献身》，叙事与推理，均已炉火纯青：最好的诡计、无懈可击的推理、恰当的伏笔，以及最普通但最不易猜透的悬念，受到大奖评委的莫大青睐，同时获得直木奖和本格推理小说大奖，更...",
  8.9,
  312366,
  55,
  37,
...
INSERT INTO book VALUES(
  ...
  "加西亚·马尔克斯（Gabriel Garcia Marquez）1927年出生于哥伦比亚马格达莱纳海滨小镇阿拉卡塔卡。童年与外祖父母一起生活。1936年随父母迁居苏克雷。1947年考入波哥大国立大学。1948年因内战辍学，进入报界。五十年代开始发表文学作品。六十年代初移居墨西哥。1967年出版《百年孤独》。1982年获诺贝尔文学奖。",
  9.2,
  223411,
  68,
  26,
...
INSERT INTO book VALUES(
  ...
  "夏洛蒂·勃朗特（ Charlotte Bronte , 1816年4月21日 --- 1855年3月31日 ）生于英国北部约克郡的豪渥斯的一个乡村牧师家庭。夏洛蒂·勃朗特有两个姐姐、两个妹妹和一个弟弟。两个妹妹，即艾米莉·勃朗特和安妮·勃朗特，也是著名作家，因而在英国文学史上常有“勃朗特三姐妹”之称。1847年，夏洛蒂·勃朗特出版著名的长篇小说《简·爱》，轰动文坛。",
  8.5,
  158124,
  41,
  44,
